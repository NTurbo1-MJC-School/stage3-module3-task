...
public class DeleteTagCommand implements Command {
    ...
    @Autowired
    public DeleteTagCommand(@Qualifier("tagController") BaseController tagController) {
        this.tagController = tagController;
        this.keyboard = new Scanner(System.in);
    }
    @Override
    public void execute() {
        System.out.println(Operations.REMOVE_TAG_BY_ID.getOperation());
        ...
        try {
            ...
            System.out.println(CommandHelper
                    .findCommandHandlerFor(Operations.REMOVE_TAG_BY_ID.getOperationNumber(), tagController)
